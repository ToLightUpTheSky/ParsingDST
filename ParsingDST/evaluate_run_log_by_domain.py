...
#         prediction_recorder.add_state(data_item, all_slot_values)
        ...
        this_jga, this_acc, this_f1 = evaluate(all_slot_values, label_item['slot_values'])

        if domain:
            this_jga, this_acc, this_f1 = evaluate(domain_filter(all_slot_values), domain_filter(label_item['slot_values']))
